...
xa.params = {
	...
	'A_Number' : {'Type': 'Number', 'Value': 42},
	'Another_Number' : {'Type': 'Number', 'Value': 21},
	'File_Test' : {'Type': 'File', 'Mode': 'Read', 'Value': '/home'},
	'Bad' : {'Type': 'Bad', 'Value': 0},
	'Parallel' : False,
