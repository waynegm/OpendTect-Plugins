...
#
xa.params = {
	'Inputs': ['Near', 'Mid', 'Far', 'ExtraFar', 'UltraFar'],
...
def doCompute():
	...
	xfar_ang = xa.params['Par_3']['Value']
	ufar_ang = xa.params['Par_4']['Value']
	angs = np.array([near_ang, mid_ang, far_ang, xfar_ang, ufar_ang])
	...
	while True:
		...
		xfar = xa.Input['ExtraFar'][0,0,:]
		ufar = xa.Input['UltraFar'][0,0,:]
		refl = np.array([near,mid,far,xfar,ufar])
		ns = near.shape[0]
