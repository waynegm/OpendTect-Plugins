...
## Release 2026.1
- transition to **pixi** build system
- rebuild against OpendTect 2026 API
- fix some minor issues in uiMistie plugin
- fix some minor issues in Geopackage/Geotiff plugin

### Grid 2D3D
- add iterative second derivative, fault aware gridding algorithm  
- fix lock issue in localInterp option

## Release 2025.2
- update dependencies

### External Attributes
- remove local copy of nlohmann/json

### Geopackage Export
- add checks that 2D geomids are valid and are 2D

### Grid 2D3D
- add checks that 2D geomids are valid and are 2D
- add out of memory checks when allocating large arrays
