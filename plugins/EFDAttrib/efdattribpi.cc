/*
 *   EFDAttrib Plugin - Empirical Fourier Decomposition
...
mDefODPluginEarlyLoad(EFDAttrib)
mDefODPluginInfo(EFDAttrib)
{
    mDefineStaticLocalObject( PluginInfo, retpi,(
	"Empirical Fourier Decomposition seismic attributes (Base)",
	wmPlugins::sKeyWMPlugins(),
	wmPlugins::sKeyWMPluginsAuthor(),
	wmPlugins::sKeyWMPluginsVersion(),
	"Various seismic attributes using Empirical Fourier Decomposition" ) );
    return &retpi;
}
