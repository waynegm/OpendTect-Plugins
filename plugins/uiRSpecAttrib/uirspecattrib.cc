...
, TestPanelAdaptor()
{
    ...
    tfpanelbut_ = new uiPushButton( this, tfstr, mCB(this, uiRSpecAttrib, showPosDlgCB), true );
    tfpanelbut_->attach( alignedBelow, reassignbut_ );
...
void uiRSpecAttrib::showPosDlgCB( CallBacker* )
{
    ...
    delete( testpanel_ );
    testpanel_ = new uiAttribTestPanel<uiRSpecAttrib>( *this,
...
void uiRSpecAttrib::fillTestParams( Attrib::Desc* desc ) const
{
    mSetParam(ZGate,gate,RSpecAttrib::gateStr(), gatefld_->getFInterval())
    mSetParam(Bool,reassign,RSpecAttrib::reassignStr(),reassignbut_->isChecked())
    ...
    mSetParam(Float,dfreq,RSpecAttrib::stepStr(), zIsTime() ? 1.f : 0.001f )
}
